...
switch ($result) {
  ...
  "NO_AUDIOMOTH_UART" {
    Write-Host "ESP32 asserted ESP_REQ and sent PING, but received zero bytes. Check AudioMoth is flashed with the request-service bin and running in CUSTOM mode."
    exit 2
  }
